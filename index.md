...
Our best explanation for the increased production is therefore linked to **internal migration**. As the situation in the cities worsened, some people emigrated out of the country [^4], but others fled to the safer eastern areas, where they devoted themselves to agriculture.
...
In the following plot, we show the percentage of **new buildings erected** during the years of the war [^6].
...
From the following table  [^8], we can also observe how the **percentage of Lebanon's GDP represented by agriculture** doubles during the war years, meaning that working people moved to agriculture from other econonomic sectors.
